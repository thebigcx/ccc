...
enum TOKTYPE
{
    ...
    T_EQ, T_EQEQ, T_NEQ, T_GT, T_LT, T_GTE, T_LTE, T_NOT, T_LAND, T_LOR, T_BITOR, T_BITXOR, T_COMP, T_TERNARY,
    ...
    T_RETURN, T_WHILE, T_IF, T_ELSE, T_FOR, T_FUNC, T_VAR, T_SIZEOF, T_GOTO, T_LABEL, T_TYPEDEF, T_EXTERN
};
